...
public class UnsecurityHostInfo {
	...
	public String getAssersown() {
		return assersown;
	}

	public void setAssersown(String assersown) {
		this.assersown = assersown;
	}
	...
	public String getSurfcertif() {
		return surfcertif;
	}

	public void setSurfcertif(String surfcertif) {
		this.surfcertif = surfcertif;
	}
