...
public class ComputerInfo extends BaseInfo{
	...
	public String getDevorigno() {
		return devorigno;
	}

	public void setDevorigno(String devorigno) {
		this.devorigno = devorigno;
	}
	...
	public void setPhylocation(String phylocation) {
	...
	public void setCakeyno(String cakeyno) {
		this.cakeyno = cakeyno;
	}
