...
<script type="text/javascript">
	$(function() {
		...
		$('#returnForm').form({
			url : '${path }/secPrintInfoManage/edit',
			onSubmit : function() {
				progressLoad();
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<form id="editForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					<td>地区</td>
					<td><input name="bus_type" type="hidden" value="清退" /><input name="id" type="hidden" value="${SecPrintInfo.id}" /><input name="region" type="text" placeholder="请输入地区"
