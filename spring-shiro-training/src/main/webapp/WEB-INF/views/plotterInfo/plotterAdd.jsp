	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<table class="grid">
			<tr>
				...
				<!-- <input name="resdepart" type="text" placeholder="请输入部门" class="easyui-validatebox" data-options="required:true" value=""> -->
				<input class="easyui-combotree" id="resdepart" name="resdepart" value="" style="height: 30px; width: 150px"
