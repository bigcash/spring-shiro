...
<script type="text/javascript">
	...
	$(function() {
		...
		historyDataGrid = $('#historyDataGrid').datagrid({
			url : '${path }/unSecPrintInfoManage/historyDataGrid',
			queryParams : {
				devno : devno,
				mac : mac
			},
...
<div style="display: none">
	<input id="id" value="${UnSecPrintInfo.id}"></input>
	<input id="mac" value="${UnSecPrintInfo.mac}"></input> 
	<input id="devno" value="${UnSecPrintInfo.devno}"></input>
	<input id="url" value="${UnSecPrintInfo.param_url}"></input>
</div>
