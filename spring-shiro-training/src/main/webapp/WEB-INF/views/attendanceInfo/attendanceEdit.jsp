	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
			<table class="grid">
				<tr>
					...
					<input name="id" type="hidden" value="${AttendanceInfo.id}" />
					<input name="propertyown" type="text" placeholder="请输入资产归属" class="easyui-validatebox" data-options="required:true" value="${AttendanceInfo.propertyown}"></td>
					<td>设备编号</td>
