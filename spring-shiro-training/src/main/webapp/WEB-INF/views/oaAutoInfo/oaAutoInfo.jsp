...
<script type="text/javascript">
	...
	$(function() {
		...
		historyDataGrid = $('#historyDataGrid').datagrid({
			url : '${path }/oaAutoInfoManage/historyDataGrid',
			queryParams : {
				mac : mac,
				devno : devno
			},
...
<div style="display: none">
	<input id="id" value="${OaAutoInfo.id}"></input>
	<%-- <input id="mac" value="${OaAutoInfo.mac}"></input>  --%>
	<input id="devno" value="${OaAutoInfo.devno}"></input> 
	<input id="url" value="${OaAutoInfo.param_url}"></input>
</div>
