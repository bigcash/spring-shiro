...
<script type="text/javascript">
							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value, row, index) {
											...
											<shiro:hasPermission name="/oaAutoInfoManage/delete">
											str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
											str += $
													.formatString(
	...
	function editFun(id) {
		...
		parent.$.modalDialog({
			...
			width : 800,
			height : 500,
			href : '${path }/oaAutoInfoManage/queryDetail?id=' + id,
			buttons : [ {
				text : '关闭',
				handler : function() {
					parent.$.modalDialog.handler.dialog('close');
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div data-options="region:'center',border:true,title:'十三所二三〇厂办公自动化设备台帐列表'">
		<table id="dataGrid" data-options="fit:true,border:false"></table>
	</div>
	<div id="toolbar" style="display:none">
		<shiro:hasPermission name="/oaAutoInfoManage/fileUpload">
