...
<script type="text/javascript">
	$(function() {
		$('#editForm').form({
			url : '${path }/internetInfoManage/edit',
			onSubmit : function() {
				progressLoad();
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<form id="editForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					<td>责任人</td>
					<td><input name="resperson" type="text" placeholder="请输入责任人" class="easyui-validatebox" data-options="required:true" value="${InternetInfo.number}"></td>
					<td>设备品牌</td>
				...
				<tr>
					...
					<td>状态</td>
					<td><input name="status" type="text" placeholder="请输入状态" class="easyui-validatebox" data-options="required:true" value="${InternetInfo.status}"></td>
				</tr>
				<tr>
					<td>打印机服务器IP</td>
