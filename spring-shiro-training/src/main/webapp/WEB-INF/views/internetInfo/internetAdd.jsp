	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<table class="grid">
			<tr>
				...
				<td>序号</td>
				<td><input name="number" type="text" placeholder="请输入序号" class="easyui-validatebox" data-options="required:true" value=""></td>
			</tr>

			<tr>
				<td>所在房间</td>
				<td><input name="roomnum" type="text" placeholder="请输入所在房间" class="easyui-validatebox" data-options="required:true" value=""></td>
				<td>设备编号</td>
			...
			<tr>
				<td>新资产号</td>
				<td><input name="newassertsno" type="text" placeholder="请输入新资产号" class="easyui-validatebox" data-options="required:true" value=""></td>
				<td>责任部门</td>
			...
			<tr>
				...
				<td>设备品牌</td>
				<td><input name="devbrand" type="text" placeholder="请输入设备品牌" class="easyui-validatebox" data-options="required:true" value=""></td>
			</tr>
			...
			<tr>
				...
				<td><input name="printhostip" type="text" placeholder="请输入打印机服务器IP" class="easyui-validatebox" data-options="required:true"
					value=""></td>
				<td>打印机MAC</td>
				<td><input name="printmac" type="text" placeholder="请输入打印机MAC" class="easyui-validatebox" data-options="required:true" value=""></td>
			</tr>
			<tr>
				<td>打印机网络端口</td>
				<td><input name="printport" type="text" placeholder="请输入打印机网络端口" class="easyui-validatebox" data-options="required:true" value=""></td>
				<td>配线架</td>
			...
			<tr>
				...
				<td>刷卡器MAC</td>
				<td><input name="paymac" type="text" placeholder="请输入刷卡器MAC" class="easyui-validatebox" data-options="required:true" value=""></td>
			</tr>
			<tr>
				<td>刷卡器网络端口</td>
				<td><input name="payport" type="text" placeholder="请输入刷卡器网络端口" class="easyui-validatebox" data-options="required:true" value=""></td>
				<td>园区</td>
				<td><input name="park" type="text" placeholder="请输入园区" class="easyui-validatebox" data-options="required:true" value=""></td>
			</tr>
