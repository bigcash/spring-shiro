...
<script type="text/javascript">
	$(function() {
		$('#addForm').form({
			url : '${path }/internetInfoManage/add',
			onSubmit : function() {
				progressLoad();
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<form id="addForm" method="post">
			<table class="grid">
				...
				<tr>
					<td>打印机服务器IP</td>
					<td><input name="printhostip" type="text" placeholder="请输入打印机服务器IP" class="easyui-validatebox" data-options="required:true" value=""></td>
					<td>打印机MAC</td>
