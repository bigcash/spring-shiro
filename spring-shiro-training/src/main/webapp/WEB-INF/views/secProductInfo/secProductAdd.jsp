	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<form id="addForm" method="post">
			<table class="grid">
				<tr>
					<td>部门名称</td>
					<td><input name="bus_type" type="hidden" value="新增" /><input name="depname" type="text" placeholder="请输入部门名称" class="easyui-validatebox" data-options="required:true" value=""></td>
					<td>责任人</td>
				...
				<tr>
					<td>状态情况</td>
					<td><input name="status" type="text" placeholder="请输入状态情况" class="easyui-validatebox" data-options="required:true" value=""></td>
					<td>地域</td>
