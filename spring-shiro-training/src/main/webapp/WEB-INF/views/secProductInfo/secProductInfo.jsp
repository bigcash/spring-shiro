...
<script type="text/javascript">
	...
	$(function() {
		...
		historyDataGrid = $('#historyDataGrid').datagrid({
			url : '${path }/secProdInfoManage/historyDataGrid',
			queryParams : {
				devno : devno,
				mac : mac
			},
...
<div style="display: none">
	<input id="id" value="${SecurityProductInfo.id}"></input>
	<input id="mac" value="${SecurityProductInfo.switchmac}"></input> 
	<input id="devno" value="${SecurityProductInfo.devno}"></input> 
	<input id="url" value="${SecurityProductInfo.param_url}"></input>
</div>
