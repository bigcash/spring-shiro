...
<div style="display: none">
	<input id="id" value="${SecurityHostInfo.id}"></input>
	<input id="mac" value="${SecurityHostInfo.mac}"></input> 
	<input id="devno" value="${SecurityHostInfo.devno}"></input> 
	<input id="url" value="${SecurityHostInfo.param_url}"></input>
</div>
