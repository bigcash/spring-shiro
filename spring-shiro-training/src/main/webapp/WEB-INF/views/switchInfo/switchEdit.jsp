...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<table class="grid">
			...
			<tr>
				<td>地区</td>
				<td><input name="bus_type" type="hidden" value="修改" /><input name="id" type="hidden" value="${SwitchInfo.id}" /><input
					name="region" type="text" placeholder="请输入地区" class="easyui-validatebox" data-options="required:true" value="${SwitchInfo.region}"></td>
				<td>准用证编号</td>
			...
			<tr>
				...
				<td><input class="easyui-combotree" id="depname" name="depname" value="${SwitchInfo.depname}" style="height: 30px; width: 150px"
				...
				<td><select class="js-example-basic-single js-states form-control" id="resperson" name="resperson" value="${SwitchInfo.resperson}"
			...
			<tr>
                ...
                <td><input name="seclevel" id="seclevel" placeholder="请输入密级" class="easyui-combobox"
                           style="height: 34px;" data-options="required:true" value="${SwitchInfo.seclevel}"></td>
			</tr>
			<tr>
				<td>计算机所在地</td>
