...
<script type="text/javascript">
	$(function() {
		$('#editForm').form({
			url : '${path }/switchInfoManage/edit',
			onSubmit : function() {
				progressLoad();
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<form id="editForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					<td>地区</td>
					<td><input name="id" type="hidden" value="${SwitchInfo.id}" /><input name="region" type="text" placeholder="请输入地区"
				...
				<tr>
					<td>设备序列号</td>
					<td><input name="devno" type="text" placeholder="请输入设备序列号" class="easyui-validatebox" data-options="required:true"
