	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden; padding: 3px;">
		<table class="grid">
			...
			<tr>
				...
				<td>IP地址</td>
				<td><input name="ip" type="text" placeholder="请输入IP地址" class="easyui-validatebox" data-options="required:true" value=""></td>
			</tr>
			...
			<tr>
				<td>终端计算机类型</td>
				<td><input name="termachtype" type="text" placeholder="请输入终端计算机类型" class="easyui-validatebox" data-options="required:true" value=""></td>
				<td>终端计算机用途</td>
