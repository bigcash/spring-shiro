...
<script type="text/javascript">
	...
	$(function() {
		...
		historyDataGrid = $('#historyDataGrid').datagrid({
			url : '${path }/notePadInfoManage/historyDataGrid',
			queryParams : {
				mac : mac,
				devno : devno
			},
...
<div style="display: none">
	<input id="id" value="${NotePadInfo.id}"></input>
	<input id="mac" value="${NotePadInfo.mac}"></input> 
	<input id="devno" value="${NotePadInfo.devno}"></input> 
	<input id="url" value="${NotePadInfo.param_url}"></input>
</div>
