...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow-y: auto; width: 100%; height: 300px; padding: 3px;">
		<form id="addForm" method="post">
			<table class="grid">

				<tr>
					<td>新增单编号</td>
					<td><input name="change_no" type="text" placeholder="请输入新增单编号" class="easyui-validatebox" data-options="required:true" value=""></td>
					<td>新增描述</td>
					<td><input name="change_content" type="text" placeholder="请输入新增描述" class="easyui-validatebox" 
						value=""></td>
				</tr>
				<tr>
