...
<script type="text/javascript">
	$(function() {
		$('#editForm').form({
			url : '${path }/convertInfoManage/edit',
			onSubmit : function() {
				progressLoad();
		...
		<form id="editForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					...
					<td>使用部门</td>
					<td><input name="usedepartment" type="text" placeholder="请输入责任部门" class="easyui-validatebox" data-options="required:true"
				...
				<tr>
					...
					<td>显示器型号</td>
					<td><input name="displaymodel" type="text" placeholder="请输入设备序列号" class="easyui-validatebox" data-options="required:true"
				...
				<tr>
					<td>主机序列号</td>
					<td><input name="hostnumber" type="text" placeholder="请输入硬盘ID" class="easyui-validatebox" data-options="required:true"
						value="${ConvertInfo.hostnumber}"></td>
					<td>硬盘ID</td>
					<td><input name="diskid" type="text" placeholder="请输入系统版本" class="easyui-validatebox" data-options="required:true"
				...
				<tr>
					...
					<td>用途</td>
					<td><input name="purpose" type="text" placeholder="请输入设备密级" class="easyui-validatebox" data-options="required:true"
						value="${ConvertInfo.purpose}"></td>
				</tr>

				<tr>
					<td>设备密级</td>
					<td><input name="secequipment" type="text" placeholder="MAC地址" class="easyui-validatebox" data-options="required:true"
						value="${ConvertInfo.secequipment}"></td>
					<td>Mac地址</td>
					<td><input name="mac" type="text" placeholder="请输入IP地址" class="easyui-validatebox" data-options="required:true"
						value="${ConvertInfo.mac}"></td>
				</tr>
				<tr>
					<td>UAB key编号</td>
					<td><input name="uabnumber" type="text" placeholder="请输入所在房间" class="easyui-validatebox" data-options="required:true"
						value="${ConvertInfo.uabnumber}"></td>
					<td>系统版本及安装时间</td>
					<td><input name="osinstall" type="text" placeholder="请输入使用状态" class="easyui-validatebox" data-options="required:true"
						value="${ConvertInfo.osinstall}"></td>
				</tr>
				<tr>
					<td>房间号</td>
					<td><input name="roomid" type="text" placeholder="请输入主要用途" class="easyui-validatebox" data-options="required:true"
						value="${ConvertInfo.roomid}"></td>
					<td>状态</td>
					<td><input name="status" type="text" placeholder="请输入接入信息点" class="easyui-validatebox" data-options="required:true"
