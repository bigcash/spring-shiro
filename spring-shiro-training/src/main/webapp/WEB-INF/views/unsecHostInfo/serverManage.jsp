							...
							columns : [ [
									...
									
									{
										...
										formatter : function(value, row, index) {
											var str = '';
											<shiro:hasPermission name="/unsecHostInfoManage/edit">
											str += $
													.formatString(
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div data-options="region:'center',border:true,title:'十三所二三〇厂非密单机台帐列表'">
		<table id="dataGrid" data-options="fit:true,border:false"></table>
	</div>
	<div id="toolbar">
		<shiro:hasPermission name="/unsecHostInfoManage/add">
